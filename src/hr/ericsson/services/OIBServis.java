...
public class OIBServis {
	...
	public OIBServis(){
		try {
			this.serviceUrl = Props.getInstance().getProperty("oib.url.request");
			this.keystoreUrl = Props.getInstance().getProperty("oib.ssl.keystore.url");
			this.keystorePassword = Props.getInstance().getProperty("oib.ssl.keystore.password");
			this.sslhost = Props.getInstance().getProperty("oib.ssl.url.host");
			this.sslport = Props.getInstance().getProperty("oib.ssl.url.port");
			this.tlsType = Props.getInstance().getProperty("oib.tls.type");
			this.authString = Props.getInstance().getProperty("oib.auth.string");
			this.requestFile=Props.getInstance().getProperty("oib.request.file");
		} catch (Exception e) {
			e.printStackTrace();
		}
